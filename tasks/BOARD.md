...
| [WO-0019](../agents/handoffs/WO-0019_batch-f-specs.md) | orchestrator → architect_docs_lead | ISSUED | **Batch F (M17–M20, the last four)** + D/E status flips + batch-E §12 fills + C-24…C-30 + rtl_lead's two conventions questions |
