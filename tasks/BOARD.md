...
| [WO-0027](../agents/handoffs/WO-0027_attack-plans.md) | orchestrator → dv_lead | ISSUED | **First attack plans**: AP-M03 + AP-M14 (dv's stated next) — C-37's abort-availability row first at M14; real RTL now exists to attack |
