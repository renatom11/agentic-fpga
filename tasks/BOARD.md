...
| [WO-0023](../agents/handoffs/WO-0023_c37-repair.md) | orchestrator → architect_docs_lead | ISSUED | **C-37 repair** (F-1's twin at frozen SPEC-M14): ADR-0012 + §13-recorded diff set — the programme's first post-freeze behavioural repair; + C-39/C-40 |
