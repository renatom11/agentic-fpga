...
| [WO-0028](../agents/handoffs/WO-0028_x9-alias-repair.md) | orchestrator → dv_lead | ISSUED | X-9 clock-alias resolution: judge rtl_lead's verdict-(b) diagnosis + repair the checker (gated clocks must still FAIL); step-order deadlock fixed in build.yml |
...
| [WO-0026](../agents/handoffs/WO-0026_emission-registration.md) | orchestrator → rtl_lead | ISSUED | RTL emission registration for M03/M04/M05 (its returned question 1) — REQ-902 double-generation evidence via CI round-trip by design |
